...
public class ListResponse  implements java.io.Serializable {
    private government.fiap.com.br.Invoice[] list;

    public ListResponse() {
    }

    public ListResponse(
           government.fiap.com.br.Invoice[] list) {
           this.list = list;
    }


    /**
     * Gets the list value for this ListResponse.
     * 
     * @return list
     */
    public government.fiap.com.br.Invoice[] getList() {
        return list;
    }


    /**
     * Sets the list value for this ListResponse.
     * 
     * @param list
     */
    public void setList(government.fiap.com.br.Invoice[] list) {
        this.list = list;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://br.com.fiap.government/", "listResponse"));
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("", "invoices"));
