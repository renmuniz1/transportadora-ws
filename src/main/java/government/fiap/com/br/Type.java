...
public class Type implements java.io.Serializable {
    ...
    public static final Type CPF = new Type(_CPF);
    public static final Type CNPJ = new Type(_CNPJ);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://br.com.fiap.government/", "type"));
    }
    /**
